...
class Report extends CI_Controller
{
  ...
  public function barangKeluarManual()
  {
    ...
    // document informasi
    $pdf->SetCreator('Kicik-PI Group');
    $pdf->SetTitle('Laporan Data Barang Keluar');
    $pdf->SetSubject('Barang Keluar');

    //header Data
    $pdf->SetHeaderData('usu.png',30,'Laporan Data','Barang Keluar',array(203, 58, 44),array(0, 0, 0));
    ...
    ob_end_clean();
    $pdf->Output(FCPATH.'assets/pdf/filename.pdf', 'F');
  }

  public function Barang_Keluar_Admin()
  {
  ...
  public function Barang_Keluar_User()
  {
    $id = $this->uri->segment(3);
    $tgl1 = $this->uri->segment(4);
    $tgl2 = $this->uri->segment(5);
    $tgl3 = $this->uri->segment(6);
    $ls   = array('id_transaksi' => $id ,'tanggal_keluar' => $tgl1.'/'.$tgl2.'/'.$tgl3);
    $data = $this->M_user->get_data('tb_barang_keluar',$ls);
    ...
    $pdf->writeHTMLCell(0, 0, '', '', $html, 0, 0, 0, true, '', true);
    ob_end_clean();
    $pdf->Output(FCPATH.'assets/pdf/laporan.pdf', 'F');
