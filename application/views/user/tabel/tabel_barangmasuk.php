    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu" >
            <li><a href="<?php echo base_url('user/form_barangmasuk')?>" id="warna"><i class="fa fa-circle-o"></i> Tambah Data Barang Masuk</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#" id="warna">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('user/tabel_barangmasuk') ?>" id="warna"><i class="fa fa-circle-o"></i> Tabel Barang Masuk</a></li>
            <li><a href="<?= base_url('user/tabel_barangkeluar')?>" id="warna"><i class="fa fa-circle-o"></i> Tabel Barang Keluar</a></li>
            <li><a href="<?= base_url('user/barang_disetujui')?>" id="warna"><i class="fa fa-circle-o"></i> Tabel Barang Persetujuan</a></li>
          </ul>
        <li>
          <a href="<?php echo base_url('user/setting')?>" id="warna">
          ...
          <div class="box box-primary" style="width:100%; background-color: #EEF2CE; color: #057d2d">
           <div class="box-header" style="margin-top : 10px; border-bottom: 2px solid #057d2d; color: #057d2d">
            ...
            <div class="box-body">
              ...
              <a href="<?=base_url('user/form_barangmasuk')?>" style="margin-bottom:10px;" type="button" class="btn btn-primary" name="tambah_data"><i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Data Masuk</a>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <?php foreach($list_data as $dd): ?>
                    ...
                    <td><a type="button" class="btn btn-warning btn-barangkeluar"  href="<?=base_url('user/barang_keluar/'.$dd->id_transaksi)?>" name="btn_barangkeluar" style="margin:auto;"><i class="fa fa-truck" aria-hidden="true"></i></a></td>
                </tr>
              <?php $no++; ?>
              <?php endforeach;?>
              <?php }else { ?>
