    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('leader/form_barangmasuk')?>" id="warna"><i class="fa fa-circle-o"></i> Tambah Data Barang Masuk</a></li>
            <li><a href="<?= base_url('leader/form_satuan')?>" id="warna"><i class="fa fa-circle-o"></i> Tambah Satuan Barang</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#" id="warna">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?= base_url('leader/tabel_barangmasuk')?>" id="warna"><i class="fa fa-circle-o"></i> Tabel Barang Masuk</a></li>
            <li><a href="<?= base_url('leader/tabel_barangkeluar')?>" id="warna"><i class="fa fa-circle-o"></i> Tabel Barang Keluar</a></li>
            <li><a href="<?= base_url('leader/tabel_satuan')?>" id="warna"><i class="fa fa-circle-o"></i> Tabel Satuan</a></li>
            <li><a href="<?= base_url('M_leader/barang_disetujui')?>" id="warna"><i class="fa fa-circle-o"></i> Tabel Barang Persetujuan</a></li>
          </ul>
        </li>
        <li class="active">
          <a href="<?php echo base_url('leader/profile')?>" id="warna">
         <i class="fa fa-user" aria-hidden="true" ></i> <span>Profile</span></a>
        </li>
        <li>
          <a href="<?php echo base_url('leader/users')?>" id="warna">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:100%; background-color: #EEF2CE; color: #057d2d">
           <div class="box-header" style="margin-top : 10px; border-bottom: 2px solid #057d2d; color: #057d2d">
            ...
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('leader/proses_persetujuan_data')?>" role="form" method="post">
