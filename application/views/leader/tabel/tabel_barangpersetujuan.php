          ...
          <div class="box box-primary" style="width:100%; background-color: #EEF2CE; color: #057d2d">
           <div class="box-header" style="margin-top : 10px; border-bottom: 2px solid #057d2d; color: #057d2d">
            ...
            <div class="box-body">
              ...
              <a href="<?=base_url('leader/tabel_barangmasuk')?>" style="margin-bottom:10px;" type="button" class="btn btn-info" name="tambah_data"><i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Data Keluar</a>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <?php foreach($list_data as $dd): ?>
                    ...
                    <td><?=$dd->satuan?></td>
                    <td><?=$dd->jumlah?></td>
                    <td> <a type="button" href="<?=base_url('leader/barang_keluar/'.$dd->id_transaksi)?>" class="btn btn-info" style="width:100%"  name="btn_kembali"><i class="fa fa-arrow-left" aria-hidden="true"></i> Setujui</a></td>
                </tr>
              <?php $no++; ?>
              <?php endforeach;?>
              <?php }else { ?>
