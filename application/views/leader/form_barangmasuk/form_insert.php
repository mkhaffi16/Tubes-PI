        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%; background-color: #EEF2CE; color: #057d2d">
           <div class="box-header" style="margin-top : 10px; border-bottom: 2px solid #057d2d; color: #057d2d">
            ...
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('leader/proses_databarang_masuk_insert')?>" role="form" method="post">
            ...
            <div class="form-group" style="display:inline-block;">
              ...
              <div class="box-footer" style="width:93%; background-color: #EEF2CE">
                ...
                <a type="button" class="btn btn-info" style="width:14%;margin-right:29%" href="<?=base_url('leader/tabel_barangmasuk')?>" name="btn_listbarang"><i class="fa fa-table" aria-hidden="true"></i> Lihat List Barang</a>
