        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%; background-color: #EEF2CE; color: #057d2d">
           <div class="box-header" style="margin-top : 10px; border-bottom: 2px solid #057d2d; color: #057d2d">
              <h1 class="box-title" style="font-size: 24px; font-family: fantasy;"><i class="fa fa-fw fa-file-text" aria-hidden="true"></i> 
              Tambah Satuan Barang</h1>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
            ...
            <?php } ?>
              ...
              <div class="form-group" style="display:inline-block;">
                <button type="reset" class="btn btn-primary" name="btn_reset" style="width:95px;margin-left:20px;"><i class="fa fa-eraser" aria-hidden="true"></i> Reset</button>
              </div>
