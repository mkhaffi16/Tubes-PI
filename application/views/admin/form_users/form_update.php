        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%; background-color: #EEF2CE; color: #057d2d">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-fw fa-user" aria-hidden="true"></i> Ubah Data Pengguna</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
            ...
            <?php } ?>
              ...
              <div class="box-body" style="margin-left: 25%;">
                <?php foreach($list_data as $d){ ?>
                  <input type="hidden" name="id" value="<?=$d->id?>">
                <div class="form-group" style="display:block;">
                  <label for="username" style="width:87%;margin-left: 0px;">Username</label>
                  <input type="text" name="username" style="width: 50%;margin-right: 67px;margin-left: 0px;"  required="" class="form-control" id="username" value="<?=$d->username?>">
                </div>
                <div class="form-group" style="display:block;">
                  <label for="email" style="width:73%;">Email</label>
                  <input type="email" name="email" style="width:50%;margin-right: 67px;" class="form-control" id="email" required="" value="<?=$d->email?>">
              </div>
              <div class="form-group" style="display:block;">
                <label for="role" style="width:73%;">Role</label>
                <select class="form-control" name="role" style="width:20%;margin-right: 18px;">
                  <?php if($d->role == 1){ ?>
            ...
            <a type="button" class="btn btn-danger" style="width:10%;margin-right:19%" onclick="history.back(-1)" name="btn_kembali"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali &nbsp;</a>
            <?php } ?>
              <!-- /.box-body -->
