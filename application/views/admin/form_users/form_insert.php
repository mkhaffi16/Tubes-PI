          ...
          <div class="container">
           ...
           <div class="box box-primary" style="width:94%; background-color: #EEF2CE; color: #057d2d">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-fw fa-user" aria-hidden="true"></i> Tambah Data Pengguna</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="container">
            ...
            <?php } ?>
              ...
              <div class="box-footer" style="width:93%;background-color: #EEF2CE; ">
                <a type="button" class="btn btn-warning" style="width:10%;margin-right:26%" onclick="history.back(-1)" name="btn_kembali"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a>
