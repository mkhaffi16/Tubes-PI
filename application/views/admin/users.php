     ...
     <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?= base_url('admin/barang_disetujui')?>" id="warna"><i class="fa fa-circle-o"></i> Tabel Barang Persetujuan</a></li>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <!-- /.box -->
          <div class="box" style=" background-color: #EEF2CE; color: #057d2d">
            <div class="box-header" style="margin-top : 10px; border-bottom: 2px solid #057d2d; color: #057d2d">
              <h1 class="box-title" style="font-size: 24px; font-family: fantasy;"><i class="fa fa-fw fa-users" aria-hidden="true"></i> 
              Daftar Pengguna</h1>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <a href="<?=base_url('admin/form_user')?>" style="margin-bottom:10px;" type="button" class="btn btn-success" name="tambah_data"><i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Data</a>
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th style="border-bottom: 2px solid #057d2d;">Username</th>
                  <th style="border-bottom: 2px solid #057d2d;">Email</th>
                  <th style="border-bottom: 2px solid #057d2d;">Jenis Akun</th>
                  <th style="border-bottom: 2px solid #057d2d;">Riwayat Login</th>
                  <th style="border-bottom: 2px solid #057d2d;">Ubah Data</th>
                  <th style="border-bottom: 2px solid #057d2d;">Hapus Data</th>
                </tr>
                </thead>
                <tbody>
                <tr>
                  ...
                  <?php foreach($list_users as $dd): ?>
                    ...
                    <?php }?>
                    <td><?=$dd->last_login?></td>
                    <td><a type="button" class="btn btn-warning"  href="<?=base_url('admin/update_user/'.$dd->id)?>" name="btn_update" style="margin:auto;"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
